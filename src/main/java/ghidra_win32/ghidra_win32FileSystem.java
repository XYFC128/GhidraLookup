...
@FileSystemInfo(type = "fstypegoeshere", // ([a-z0-9]+ only)
		description = "File system description goes here", factory = ghidra_win32FileSystem.MyFileSystemFactory.class)
public class ghidra_win32FileSystem implements GFileSystem {
	 ...
	 */
	public ghidra_win32FileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + ghidra_win32FileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryFull<ghidra_win32FileSystem>, GFileSystemProbeFull {

		@Override
		public ghidra_win32FileSystem create(FSRL containerFSRL, FSRLRoot targetFSRL,
				ByteProvider byteProvider, File containerFile, FileSystemService fsService,
				TaskMonitor monitor) throws IOException, CancelledException {

			ghidra_win32FileSystem fs = new ghidra_win32FileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
